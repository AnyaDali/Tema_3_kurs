    ...
    while (i > 0)
    {
        ...
        else
        {
            ...
            if (j < k - 1)
            {
                ...
                if (i == n - 1)
                {
                    ...
                    if (j == -1)
                    {
                        ...
                        /*if (!st_m.empty())
                        {
                            std::get<lexeme_alg::Q_BORDER>(st_m.top()) = k - 1;
                        }*/
                        return;
                    }
                    ...
                    if (!st_m.empty())
                    {
                        // std::get<lexeme_alg::I_ITER>(st_m.top()) = j;
                        std::get<lexeme_alg::Q_BORDER>(st_m.top()) = k - 1;
                    }
                    // std::cout << std::get<lexeme_alg::U_SET>(st_m.top()) << std::endl;
            ...
            else
            {
                ...
                /*
                                if (!st_m.empty())
                                    std::get<lexeme_alg::Q_BORDER>(st_m.top()) = l[i];
                                // q = l[i];
                */
                updateU = false;
                return;
